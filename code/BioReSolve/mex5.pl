...
myentities([out_1,out_2,out_3,out_4,out_5]).
...
myreactions([
    ...
    react([req_1,act_1],[lock,act_2,act_3,act_4,act_5],[in_1,lock]),
    ...
    react([req_2,act_2],[lock,act_1,act_3,act_4,act_5],[in_2,lock]),
    ...
    react([req_3,act_3],[lock,act_1,act_2,act_4,act_5],[in_3,lock]),
    ...
    react([req_4,act_4],[lock,act_1,act_2,act_3,act_5],[in_4,lock]),
    ...
    react([req_5,act_5],[lock,act_1,act_2,act_3,act_4],[in_5,lock]),
