...
We write $C.\mathsf{K}$ as a shorthand for the trivially guarded process $(\emptyset,\emptyset,C).\mathsf{K}$ and we assume the trivial recursive process $\mathsf{Emp}=\emptyset.\mathsf{Emp}$ is always available.
