...
Finally, two more reactions model the passage of time (morning vs afternoon) while the student is idle (i.e., not in the process of getting coffee).
\[
\begin{array}{lll}
...
We assume that, initially, both entitities $\cpowder$ and $\tpowder$ are present.\todo{Currently, \am is initially not present, meaning that the day starts at PM}
