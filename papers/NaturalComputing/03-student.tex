...
Note that, as \am is initially not present, it means that the initial time is in the afternoon. In drawing the transition system, we have used the representational convention explained in \Cref{rem:shortlts}).
