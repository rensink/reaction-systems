...
The generation of occurrence graphs involves the tool chain depicted in \Cref{fig:chain}, the phases of which will be explained in some more detail in the remainder of this section.	

\begin{figure}
\centering
\includegraphics[scale=.27]{figs/chain}
\caption{Reaction System exploration and occurrence graph generation using \GROOVE}
\label{fig:chain}
\end{figure}
...
\medskip\noindent\textbf{Build.}
%
The purpose of this phase is to build an occurrence graph that explains how \Forbidden was produced, by collecting its (transitive) dependencies. Concretely, we record the following dependencies (see \Cref{fig:occur-type} for the occurrence type graph):
\begin{itemize}
