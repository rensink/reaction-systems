...
In order to replicate these results, we can use CTL model checking. For instance the relevant CTL property for the major risks is shown in 
\Cref{fig:table-from-cmsb2024}. Running the CTL model checker built into GROOVE, it reports that this is indeed satisfied, as are the corresponding characteristic properties for the moderate and minor risks. The following table reports the time taken for these checks:
...
\item \todo{Something about the CTL ckeck}
\end{itemize}
