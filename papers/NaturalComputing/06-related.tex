...
Besides (bounded) model checking of ad hoc designed temporal logics tailored to reaction systems, \ReactICS supports context automata, reactions with concentration levels, parameter/reaction synthesis and parameter optimisation.
...
This form of causal reasoning is not available in high-performance tools such as \HERESY, \WebRSim, \clrs, or \ReactICS and is only partially addressed in \ccReact, where the focus is primarily on reachability and temporal properties. 
