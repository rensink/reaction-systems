...
For replication of the \GROOVE experiments, we provide an archive with supplementary material, described in \Cref{app:groove}.
...
by the INdAM-GNCS Projects \emph{Reversibilit\`a In SIstemi COncorrenti: analisi Quantitative e Funzionali} (RISICO,  CUP E53C22001930001) and  \emph{Modelli e Analisi per sistemi reversibili e quantistici} (MARQ, CUP E53C24001950001),
...
\GROOVE is an open-source tool, available at \url{https://github.com/nl-utwente-groove/code}. For replication of the \GROOVE experiments reported in this paper, we provide supplementary material described in \Cref{app:groove}.
